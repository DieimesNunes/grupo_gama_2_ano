    ...
    <body>
        ...
        <main>
            <section class="produto">
                ...
                <div>
                    <img src="../fotos/nike.png" alt="Produto Listrada Zebra">
                </div>
                <ul>
                    <li><div><h2>TENIS W NIKE REACT INFINITY RUN FK 3</h2></div></li>
                    ...
                    <li>Variante: <button>Branco</button></li>
                    <li>Quantidade: 
