    ...
    <body>
        ...
        <main>
            <section class="produto">
                ...
                <div>
                    <img src="../fotos/teniszoom.png" alt="Produto Listrada Zebra">
                </div>
                <ul>
                    <li><div><h2>Tênis Nike Air Zoom Pegasus</h2></div></li>
                    ...
                    <li>Variante: <button>Preto, Branco e Dourado</button></li>
                    <li>Quantidade: 
